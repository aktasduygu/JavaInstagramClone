package com.example.javainstagramclone.adaptör;
...
public class PostAdapter extends RecyclerView.Adapter<PostAdapter.PostHolder> {
    ...
    public void onBindViewHolder(@NonNull PostHolder holder, int position) {
        ...
        Picasso.get().load(postArrayList.get(position).downloaderUrl).into(holder.recyclerRowBinding.recyclerViewImageView);
